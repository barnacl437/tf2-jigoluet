...
Scheme
{
	Colors
	{
		...
		"G_ActiveWindow"			"27 27 27 255" // Active window bg color
		"G_InctiveWindow"			"159 159 159 245" // Inactive window bg color
		"G_TitleBg"					"25 176 250 255" // Title bg color
		"G_TitleText"				"0 0 0 255" // Title text color
		"G_Highlight"				"30 188 228 255" // Highlight color
		"G_ConsoleBg"				"47 37 121 255" // Console bg color
		"G_ListBg"					"14 47 73 255" // List bg color
		"G_Border"					"0 0 0 50" // Border color
		"G_Text"					"242 241 244 255" // Text color
		"G_HighlightText"			"6 9 12 255" // Highlight text color
		"G_SelectedText"			"254 252 255 255" // Selected text color
		"G_DisabledText"			"77 154 176 224" // Disabled text color
		"G_ButtonBg"				"63 36 181 255" // Button bg color
		"G_ButtonText"				"236 236 236 255" // Button text color
		"G_ButtonHoverBg"			"8 232 178 255" // Button hover bg color
		"G_ButtonHoverText"			"8 2 55 255" // Button hover text color
		"G_InputBg"					"12 25 84 255" // Input bg color
	    ...
	    "QuickListBGSelected"       "30 188 228 255" // Highlight color
