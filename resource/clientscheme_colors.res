Scheme
{
	...
	Colors
	{
		...
		"G_Highlight"			"106 0 181 255" // Highlight color
		"G_White"				"255 255 255 255"
		"G_Black"				"0 0 0 255"
		"G_Red"					"230 0 0 255"
		"G_Shadow"				"2 78 99 222" // Shadow color
		"G_LightShadow"			"0 0 0 110"
		"G_Heal"				"74 224 204 255" // Heal color
		...
		"G_LightGrey"			"55 195 37 255" // Metal color in build/destroy menu
		"G_HealthBarBg"			"0 0 0 220" // Target health bg
		"G_CurrencyBad"			"255 60 60 255" // Red currency in MvM
		"G_TransparentMenuBG"	"91 98 158 82" // Transparent menu color
		"G_PanelBg"				"0 11 13 212" // Panel color
		"G_OpaquePanelBg"		"0 11 13 255" // Opaque Panel color
		"G_Warning"				"255 11 0 255" // Warning color
		"G_HealthValue"			"255 255 255 255" // Health value color
		"G_Overheal"			"70 200 239 255" // Overhealed health value color
		"G_LowHealthValue"		"244 149 113 255" // Low health value color
		"G_AmmoClipValue"		"255 255 255 255" // Ammo in clip value color
		"G_AmmoReserveValue"	"2 157 252 255" // Ammo in reserve value color
		"G_LowAmmo"				"255 0 0 255" // Low ammo color
		"G_MetalValue"			"55 195 37 255" // Metal color
		"G_MetalIcon"			"99 143 234 255" // Metal icon color
		"G_HeadsValue"			"235 220 50 255" // Heads value color
		"G_HeadsLabel"			"240 231 5 255" // Heads value icon color
		"G_KillstreakValue"		"155 125 238 255" // Killstreak value color
		"G_KillstreakIcon"		"255 135 80 255" // Killstreak icon color
		"G_StickyColor"					"238 99 99 255" // Stickybomb color
		"G_StickyIconColor"				"35 211 108 255" // Stickybomb icon color
		...
		"G_Footer"					"12 51 62 255" // Menu footer color
		"G_DimmFooter"				"28 23 19 200" // Dimm Menu footer color
		"G_FooterText"				"59 231 233 255" // Footer text color
		...
		"G_MainMenuPanel"			"4 1 30 255" // Main Menu panel color
		"G_MainMenuButton"			"43 185 234 255" // Main Menu button color
		"G_MainMenuButtonHover"		"93 13 212 255" // Main Menu hovered button color
		"G_MainMenuButtonFg"		"24 21 17 255" // Main Menu button text color
		...
		"G_LoadoutItemBg"			"43 62 125 255" // Loadout item bg color
		"G_MenuBg"					"16 33 49 255" // Menu bg color
		"G_MenuText"				"90 206 227 255" // Menu text color
		"G_InputText"				"0 0 0 240" // Input text color
		"G_DimmInputText"			"0 0 0 100" // Dimm Input text color
		"G_DimmMenuText"			"90 206 227 120" // Dimm Menu text color
		"G_ItemDescriptionPanelBg"	"10 25 39 255" // Item description panel bg
		"G_ButtonBg"				"39 127 172 255" // Button bg color
		"G_ButtonText"				"244 244 244 255" // Button text color
		"G_ButtonHoverBg"			"32 110 114 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 255" // Button hover text color
		"G_ButtonSelectedBg"		"51 53 156 255" // Button selected bg color
		"G_ButtonSelectedText"		"208 208 208 255" // Button selected text color
		...
		"TFOrange"			"106 0 181 255" // Highlight color
		...
		"QualityColorDeveloper"					"165 15 49 255" // IQC Valve
		...
		"QualityColorCollectors"				"238 39 39 255" // IQC Collectors
		...
		"DimmQualityColorDeveloper"				"165 15 49 100" // Dimm IQC Valve
		...
		"DimmQualityColorCollectors"			"238 39 39 100" // Dimm IQC Collectors
	...
	BaseSettings
	{
		...
		Slider.NobColor				"106 0 181 255" // Highlight color
		Slider.TextColor			"90 206 227 255" // Menu text color
		Slider.TrackColor			"90 206 227 255" // Menu text color
		Slider.DisabledTextColor1	"90 206 227 120" // Dimm Menu text color
		Slider.DisabledTextColor2	"90 206 227 120" // Dimm Menu text color
